...
def menu_produtos():
    ...
    print("5. Sair")
    opcao_prod = input("Escolha uma opcao: ")
    return opcao_prod
...
def menu_fornecedor():
    ...
    print("5. Sair")
    opcao_forn = input("Escolha uma opcao: ")
    return opcao_forn
...
def menu_pedidos():
    ...
    print("3. Alterar pedidos")
    print("4. Deletar pedidos")
    print("5. Sair")
    opcao_pedidos = input("Escolha uma opcao: ")
    return opcao_pedidos